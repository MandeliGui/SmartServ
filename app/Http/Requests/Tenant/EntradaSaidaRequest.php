...
use App\Enums\Tenant\EntradaSaidaPersistence;
use App\Http\Requests\BaseValidationRequest;
use App\Http\Requests\Tenant\EntradaSaida\CriarEntradaSaidaRequest;
use App\Http\Requests\Tenant\EntradaSaida\DarBaixaEntradaSaidaRequest;
...
class EntradaSaidaRequest
{
    ...
    public function __construct(
        ...
        private readonly Persistence|EntradaSaidaPersistence $persistence,
    ...
    )
    {
        $this->validationRequest = match ($this->persistence) {
            ...
            EntradaSaidaPersistence::DAR_BAIXA => new DarBaixaEntradaSaidaRequest($this->data, $this->attributes),
    ...
    public static function darBaixa(array $data, array $attributes = []): self
    {
        return new self($data, EntradaSaidaPersistence::DAR_BAIXA, $attributes);
    }
