...
use App\Http\Requests\Tenant\Atendentes\CriarAtendenteRequest;
use App\Http\Requests\Tenant\Atendentes\EditarAtendenteRequest;
use App\Http\Requests\Tenant\Atendentes\RemoverAtendenteRequest;

class AtendenteRequest
{
    ...
    )
    {
        $this->validationRequest = match ($this->persistence) {
            Persistence::CREATE => new CriarAtendenteRequest($this->data, $this->attributes),
            Persistence::UPDATE => new EditarAtendenteRequest($this->data, $this->attributes),
            Persistence::REMOVE => new RemoverAtendenteRequest($this->data, $this->attributes),
        };
    }
