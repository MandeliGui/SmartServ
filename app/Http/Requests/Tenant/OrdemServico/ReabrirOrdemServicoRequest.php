...
class ReabrirOrdemServicoRequest extends BaseValidationRequest
{
    ...
    public function prepareForValidation(): void
    {
        $this->data = [
            ...
            'status' => StatusOrdemServico::EM_ANDAMENTO->value,
        ];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['required', 'string', 'in:' . StatusOrdemServico::EM_ANDAMENTO->value],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'status.in'       => ':attribute deve ser um dos seguintes valores: ' . StatusOrdemServico::EM_ANDAMENTO->value,
        ];
    }
