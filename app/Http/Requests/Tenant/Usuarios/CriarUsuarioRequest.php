...
namespace App\Http\Requests\Tenant\Usuarios;
...
class CriarUsuarioRequest extends BaseValidationRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cpfCnpj'              => ['required', 'string', 'max:11', 'min:11'],
    ...
    {
        return [
            'nomeRazaoSocial.required'    => 'O campo :attribute é obrigatório.',
            'nomeRazaoSocial.string'      => 'O campo :attribute deve ser uma string.',
            'nomeRazaoSocial.max'         => 'O campo :attribute deve ter no máximo 200 caracteres.',
            ...
            'cpfCnpj.max'                 => 'O campo :attribute deve ter no máximo 11 caracteres.',
