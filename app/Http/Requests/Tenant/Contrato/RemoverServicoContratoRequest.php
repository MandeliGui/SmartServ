...
class RemoverServicoContratoRequest extends BaseValidationRequest
{
    ...
    {
        return [
            'id' => ['required', 'integer', 'exists:tb_contrato_servicos,id'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'id.exists'   => ':attribute informado não existe na tabela de serviços da ordem de serviço.',
        ];
    }
