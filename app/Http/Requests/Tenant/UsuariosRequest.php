...
use App\Http\Requests\Tenant\Usuarios\CriarUsuarioRequest;
use App\Http\Requests\Tenant\Usuarios\EditarUsuarioRequest;
use App\Http\Requests\Tenant\Usuarios\RemoverUsuarioRequest;
...
class UsuariosRequest
{
    ...
    public function __construct(
        ...
        $this->validationRequest = match ($this->persistence) {
            ...
            Persistence::UPDATE => new EditarUsuarioRequest($this->data, $this->attributes),
            Persistence::REMOVE => new RemoverUsuarioRequest($this->data, $this->attributes),
        };
    }
