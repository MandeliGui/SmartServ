...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        try {
            ...
            if ($this->persistence == Persistence::UPDATE) {
                ...
                $fornecedor = $this->form->update();


                Flux::toast('Fornecedor atualizado com sucesso!', variant: 'success');
                $this->redirect(route('fornecedores'), navigate: true);

            } else {

                $fornecedor = $this->form->create();


                Flux::toast('Fornecedor cadastrado com sucesso!', variant: 'success');

                $this->redirect(route('fornecedores'), navigate: true);

            }
        } catch (Throwable $e) {
            Flux::toast('Erro ao cadastrar fornecedor!', variant: 'danger');
            throw $e;
        }
    ...
    public function buscarCnpj()
    {
        ...
        $dadosEmpresa = Helper::obterDadosEmpresaPorCnpj($this->form->cnpj);
...
//    }
    ...
    public function mount()
    {
        ...
        if ($this->id) {
            ...
            $this->form->setFornecedor($this->id);
...
<div x-data>
    <form wire:submit.prevent="save">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 my-4">
            ...
            <flux:input label="Atendente" placeholder="Insira o nome do seu contato no fornecedor"
                        wire:model="form.atendente"
                        name="atendente"
            />
