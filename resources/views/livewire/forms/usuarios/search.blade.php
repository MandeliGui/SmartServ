...
new class extends Component {
    ...
    {
        $this->selectedsIds = $value ? $this->usuarios->pluck('id')->toArray() : [];
    }
    ...
    public function getUsuariosProperty()
    {
        ...
        return (new UsuarioService())->findAll($filterPaginateRequest, $filters);
    }
    ...
    public function updatedSelectAll($value): void
    {
        if ($value) {
            ...
            $this->selectedsIds = Usuario::query()->where("removido", "=", false)->select("id")->pluck('id')->toArray();
    ...
    {
        return Usuario::query()->where("removido", "=", false)->select("id")->pluck('id')->toArray();
    }

    #[On(UsuariosForm::EVENT_PERSISTED)]
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    ...
                                    <x-delete-button-table
                                        ...
                                        wire:click="$dispatchTo(
                                                                                    '{{ \App\Livewire\Forms\UsuariosForm::PATH_COMPONENT_FORM_REMOVE }}',
                                                                                    '{{ \App\Livewire\Forms\UsuariosForm::EVENT_NAME_SHOW_MODAL_REMOVE }}',
                                                                                    {
                                                                                        modalName: '{{ \App\Livewire\Forms\UsuariosForm::MODAL_NAME_REMOVE }}',
                                                                                        id: '{{ $tecnico->id }}'
                                                                                    }
                                                                                )"
                                    />
