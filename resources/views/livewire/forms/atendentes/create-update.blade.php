...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        if ($this->persistence == Persistence::UPDATE) {
            ...
            $this->dispatch(AtendenteForm::EVENT_PERSISTED, persistence: Persistence::UPDATE->value, cliente: $cliente);

            $this->redirect(route('atendentes'), navigate: true);
        } else {

            $cliente = $this->form->create();


            $this->dispatch(AtendenteForm::EVENT_PERSISTED, persistence: Persistence::CREATE->value, cliente: $cliente);
            $this->redirect(route('atendentes'), navigate: true);
        }
    ...
    public function mount()
    {
        ...
        if ($this->id) {
            ...
            $this->form->setAtendente($this->id);
